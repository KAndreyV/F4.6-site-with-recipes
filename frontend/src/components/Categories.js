    ...
    return(
        <>
            ...
            <div className="categories">
                ...
                <Link className="btn-primary" to="http://localhost:8080/categories/Напитки">Напитки</Link>
                <Link className="btn-primary" to="http://localhost:8080/categories/Закуски">Закуски</Link>
